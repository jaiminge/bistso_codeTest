...
public class OrderModelImpl implements OrderModel {
    ...
    @Override
    public List<Order> ordersForUser(long userId, Order.Status status, Currency currency, Currency major) {
        return orders.values().stream().filter(o -> o.getUserId() == userId)
                ...
                .filter(o -> major == null || major == o.getMajor() || major == o.getMajor())
    ...
    @Override
    public List<Order> book(String major, String minor) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
